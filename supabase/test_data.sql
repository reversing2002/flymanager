...
DELETE FROM auth.users WHERE email LIKE '%@skyprout.fr';
...
INSERT INTO users (id, auth_id, first_name, last_name, email, role, balance, login, password) VALUES
    -- Club de Paris
    ('aaaaaaaa-0000-0000-0000-000000000000', 'aaaaaaaa-0000-0000-0000-000000000000', 'Admin', 'System', 'admin@skyprout.fr', 'ADMIN', 1000, 'admin', 'TemporaryPassword123!'),
    ('aaaaaaaa-1111-1111-1111-111111111111', 'aaaaaaaa-1111-1111-1111-111111111111', 'Marie', 'Martin', 'instructor@skyprout.fr', 'INSTRUCTOR', 500, 'instructor', 'TemporaryPassword123!'),
    ('aaaaaaaa-2222-2222-2222-222222222222', 'aaaaaaaa-2222-2222-2222-222222222222', 'Jean', 'Dupont', 'pilot@skyprout.fr', 'PILOT', 750, 'pilot', 'TemporaryPassword123!'),
    ('aaaaaaaa-3333-3333-3333-333333333333', 'aaaaaaaa-3333-3333-3333-333333333333', 'Pierre', 'Dubois', 'mechanic@skyprout.fr', 'MECHANIC', 0, 'mechanic', 'TemporaryPassword123!'),
    -- Club de Lyon
    ('bbbbbbbb-1111-1111-1111-111111111111', 'bbbbbbbb-1111-1111-1111-111111111111', 'Sophie', 'Laurent', 'sophie.laurent@skyprout.fr', 'INSTRUCTOR', 600, 'sophie', 'TemporaryPassword123!'),
    ('bbbbbbbb-2222-2222-2222-222222222222', 'bbbbbbbb-2222-2222-2222-222222222222', 'Lucas', 'Bernard', 'lucas.bernard@skyprout.fr', 'PILOT', 300, 'lucas', 'TemporaryPassword123!'),
    -- Club de Bordeaux
    ('cccccccc-1111-1111-1111-111111111111', 'cccccccc-1111-1111-1111-111111111111', 'Emma', 'Petit', 'emma.petit@skyprout.fr', 'INSTRUCTOR', 800, 'emma', 'TemporaryPassword123!'),
    ('cccccccc-2222-2222-2222-222222222222', 'cccccccc-2222-2222-2222-222222222222', 'Thomas', 'Roux', 'thomas.roux@skyprout.fr', 'PILOT', 450, 'thomas', 'TemporaryPassword123!');
