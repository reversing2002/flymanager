...
const Navbar = () => {
  ...
  console.log("User object in Navbar:", {
    email: user?.email,
    roles: user?.roles,
  ...
  const canAccessMembers = true; // Accès pour tous
              ...
              <div className="border-t border-slate-200 pt-4 mt-4">
                <div className="px-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 mt-4 px-2 py-1.5 w-full text-left text-sm text-slate-300 hover:bg-slate-800 rounded-md"
                  >
