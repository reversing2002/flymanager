      ...
      >
        ...
        <div className="px-3 py-4 border-b border-gray-800">
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full h-9 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors flex items-center justify-center text-sm"
            >
        ...
        <nav className="mt-4">
          <div className="space-y-1 px-3">
            ...
            <Link
              to="/login"
              className="flex items-center h-10 px-3 mt-4 rounded-md text-white bg-blue-500 hover:bg-blue-600 transition-colors"
            >
              <LoginIcon className="w-6 h-6 mr-3" />
