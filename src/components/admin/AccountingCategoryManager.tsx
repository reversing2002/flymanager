...
const AccountingCategoryManager = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Formulaire d'ajout */}
      <form onSubmit={handleAddCategory} className="bg-white rounded-lg p-6 border">
        <h3 className="text-lg font-semibold mb-4">Ajouter une catégorie comptable</h3>
                        ...
                        <div className="flex items-center gap-2">
                          {category.is_default ? (
                            ...
                            <button
                              ...
                              title="Définir comme catégorie par défaut"
                            >
                              <Star className="h-4 w-4" />
                            </button>
                          )}
