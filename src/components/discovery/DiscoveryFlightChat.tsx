        ...
        >
          {messages.map((message) => (
            ...
            >
              ...
              <Box
                maxW="70%"
                bg={message.author === 'client' ? 'blue.500' : 'white'}
                color={message.author === 'client' ? 'white' : 'black'}
                p={3}
                borderRadius="lg"
                boxShadow="sm"
              >
                <Text fontSize="sm">{message.body}</Text>
                <Text fontSize="xs" color={message.author === 'client' ? 'whiteAlpha.700' : 'gray.500'} mt={1}>
