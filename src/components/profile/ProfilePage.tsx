...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Calculate balances
        const validatedBalance = (transactionsData || [])
  ...
  const handleDismissAnnouncement = async (id: string) => {
    ...
    // Supprimer l'appel à supabase ici car il est déjà fait dans AnnouncementBanner
  };
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="text-3xl font-bold text-slate-900">
              {stats.validatedBalance.toFixed(2)} €
            </div>
            {stats.pendingBalance !== 0 && (
              <div className="text-sm text-amber-600 mt-1">
                En attente : {stats.pendingBalance.toFixed(2)} €
              </div>
            )}
